        ...
        <div class="row gap-5">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                <select name="ruangan_awal_id" id="ruangan_awal_id" class="form-control ruangan-awal-select"
                    wire:model='ruangan_awal_id' required>
                    <option value="">Pilih</option>
                  @foreach ($ruangans as $item)
                    <option value="{{$item->id}}" {{$ruangan_awal_id==$item->id ? 'selected' : ''}}>{{$item->nama_ruangan}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="row gap-5">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                <input type="text" class="form-control @error('ruangan_tujuan') is-invalid @enderror"
                    ...
                    placeholder="Masukkan Pendidikan Terakhir" wire:model='ruangan_tujuan' required>
            </div>
        </div>
    </div>
