        ...
        <div class="row gap-5">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8 font-weight-normal">             
                <select name="ruangan_id" id="ruangan_id"
                    ...
                    <option value="{{ $item->id }}" {{ $ruangan_id == $item->id ? 'selected' : ''}}>{{ strtoupper($item->nama_ruangan )}}</option>
                    @endforeach
    ...
    <div class="mb-4 {{ $ruangan_id == 'ruangan_lainnya' ? 'd-block' : 'd-none' }}">
        <div class="row gap-5">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                <input type="text" class="form-control @error('nama_ruangan') is-invalid @enderror" id="ruangan" aria-describedby="ruangan" name="nama_ruangan"
