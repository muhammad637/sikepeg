    ...
    <div class="card p-4 mx-5 mb-5 ">
                ...
                <div class="h-100 p-4">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{ $str->asn->pegawai->nama_depan }}"
                                    readonly>
                            </div>
                        </div>
                        {{-- {{ $str->asn->pegawai->nama_depan }} --}}
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Tempat / Tanggal
                                Lahir</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{$str->asn->pegawai->tempat_lahir.", ".Carbon\Carbon::parse($str->asn->pegawai->tanggal_lahir)->format('d-M-Y') }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Jenis
                                Kelamin</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{$str->asn->pegawai->jenis_kelamin}}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{$str->asn->pegawai->no_ijazah}}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Tanggal
                                Lulus</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{$str->asn->pegawai->tanggal_lulus}}" readonly>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form>
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Perguruan
                                Tinggi</label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="inputEmail3" value="{{$str->asn->sekolah}}" readonly>
                            </div>
                        </div>
                        {{-- <div class="row mb-3">
        ...
        <div class="row justify-content-between">
            ...
            <div class="text-right">
                <a  class="btn btn-warning" href="{{route('str.history',['asn' => $str->asn->id])}}"><i class="fas fa-history"></i>
                    Lihat History STR</a>
            </div>
        </div>
    </div>
