    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
                ...
                <div class="h-100 p-4">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3"
                                    value="{{ $str->pegawai->nama_lengkap ?? $str->pegawai->nama_depan }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3"
                                    value="{{ $str->pegawai->jenis_kelamin }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3"
                                    value="{{ $str->pegawai->no_ijazah }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3"
                                    value="{{ $str->pegawai->tanggal_lulus }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="inputEmail3"
                                    value="{{ $str->pegawai->sekolah }}" readonly>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="h-100 p-4">
                    <form>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{ $str->no_str }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="inputEmail3" value="{{ $str->kompetensi }}"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" value="{{ $str->no_sertikom }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="inputEmail3"
                                    value="{{ $str->tanggal_terbit_str }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
        ...
        <div class="row justify-content-between">
            ...
            <div class="text-right">
                <a class="btn btn-warning" href="{{ route('admin.str.history', ['pegawai' => $str->pegawai->id]) }}"><i
