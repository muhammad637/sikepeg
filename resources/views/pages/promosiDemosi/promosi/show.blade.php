...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        <h4 class="m-0 font-weight-bold text-dark">Form Edit Data Promosi</h4>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="jabatan_selanjutnya" name="jabatan_selanjutnya"
                            readonly value="{{ old('jabatan_selanjutnya', $promosiDemosi->jabatan_selanjutnya) }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="penyelenggara" class="col-sm-4 col-form-label">Tanggal Berlaku<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tanggal_berlaku" name="tanggal_berlaku" readonly
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="no_sk" name="no_sk" readonly
                ...
                <div class="row mb-3">
                    <label for="tahun" class="col-sm-4 col-form-label">Tanggal SK<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tanggal_sk" name="tanggal_sk" readonly
                ...
                <div class="row mb-3">
                    <label for="uploadLinkSK" class="col-sm-4 col-form-label">Upload Link SK<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="uploadLinkSK" name="link_sk" readonly
                            value="{{ old('link_sk', $promosiDemosi->link_sk) }}">
                    </div>
                </div>
                <div>
                    <a class="btn btn-secondary" href="{{ route('admin.jabatan.promosi.index') }}">Kembali</a>
                </div>
            </div>
        </div>
        </form>
