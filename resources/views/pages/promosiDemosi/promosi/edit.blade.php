...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        ...
        <form action="{{ route('admin.jabatan.promosi.update', ['promosiDemosi' => $promosiDemosi->id]) }}" method="post">
            @csrf
            @method('put')
        ...
        <div class="text-right">
            <a href="{{ route('admin.jabatan.promosi.index') }}" class="btn bg-warning text-white">Tutup</a>
