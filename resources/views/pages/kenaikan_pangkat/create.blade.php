...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        ...
        <form action="{{ route('admin.kenaikan-pangkat.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="fileInput" name="link_sk" required>
