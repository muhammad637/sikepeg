...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        <h2 class="m-0 font-weight-bold text-dark">Edit Diklat Pegawai Douglas McGee</h2>
            ...
            <div class="row">
                <div class="col-sm-12 col-xl-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3" value="Pelantikan ">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">Jumlah Jam</label>
                        <div class="col-sm-8">
                            <input type="int" class="form-control" id="inputPassword3" value="8 Jam">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">Penyelenggara</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3" value="Mustakim">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">Tempat</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3" value="RSUD Blambangan">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">Tahun</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3" value="2023">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">No STTPP</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3" value="1000-192-101282-11">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="noRegister" class="col-sm-4 col-form-label">Tanggal STTPP</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="inputPassword3" value="22/09/2023">
                        </div>
                    </div>
        </form>
