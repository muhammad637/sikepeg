 <div class="d-flex justify-content-center">
    <a class='btn btn-info mr-1' href="{{ route('admin.diklat.show', ['diklat' => $model->id]) }}"><i class='fas fa-info-circle'></i></a>
    <a href="{{ route('admin.diklat.edit', ['diklat' => $model->id]) }}" class='btn text-white btn-warning mr-1'><i
