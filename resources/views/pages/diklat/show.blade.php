...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        <h4 class="m-0 font-weight-bold text-dark">Detail Diklat</h4>
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8 text-secondary">
                            <input type="text" class="form-control" value="{{$diklat->pegawai->nama_lengkap ?? $diklat->pegawai->nama_depan}}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputPassword3"
                                value="{{ $diklat->penyelenggara }}" name="penyelenggara" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control" id="inputPassword3"
                                value="{{ $diklat->no_sertifikat }}" name="no_sertifikat" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="text-right">
                        <a href="{{route('admin.diklat.index')}}" class="btn btn-warning">Tutup</a>
