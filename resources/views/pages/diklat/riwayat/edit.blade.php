@extends('main', ['title' => 'Edit Diklat Riwayat'])
@push('style-css')
    @livewireStyles
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8 text-secondary">
                            <input type="hidden" value="{{$diklat->pegawai_id}}" name="pegawai_id">
                            ...
                            <input class="form-control" id="pegawai" name="nama_pegawai"
                                value="{{ $diklat->pegawai->nama_depan }} {{ $diklat->pegawai->nama_belakang }}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="nama_diklat" class="col-sm-4 col-form-label">Nama Ruangan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="nama_diklat" value="{{ $diklat->ruangan->nama_ruangan }}"
                                name="" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
