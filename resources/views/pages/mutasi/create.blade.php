                                ...
                                <div class="row gap-5">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                                        <select name="pegawai" id="pegawai"
                                            ...
                                            <option value="Roni Subakti"
                                                {{ old('pegawai') == 'pegawai' ? 'selected' : '' }}>Roni Subakti
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row gap-5">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                                        <select name="jenis_mutasi" id="jenis_mutasi"
                                            ...
                                            <option value="aktif"
                                                {{ old('jenis_mutasi') == 'internal' ? 'selected' : '' }}>Internal</option>
                                            <option value="aktif"
                                                {{ old('jenis_mutasi') == 'eksternal' ? 'selected' : '' }}>Eksternal</option>
