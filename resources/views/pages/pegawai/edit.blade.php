                            ...
                            <div class="row gap-5">
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                                    <input type="text" class="form-control @error('gelar_depan') is-invalid @enderror"
                                        id="gelar_depan" aria-describedby="gelar_depan" name="gelar_depan"
                                        autocomplete="false" value="{{ old('gelar_depan', $pegawai->gelar_depan) }}">
                                </div>
                            </div>
                        </div>
                        <div class="mb-4">
                            ...
                            <div class="row gap-5">
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        ...
                                        placeholder="Masukkan Alamat ..." value="{{ old('alamat', $pegawai->alamat) }}">
                                </div>
                            </div>
                        </div>
                        <div class="mb-4">
                            ...
                            <div class="row gap-5">
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8">
                                    <select name="status_pegawai" id="status_pegawai"
                                        ...
                                        <option value="">Pilih</option>
                                        <option value="aktif" {{ old('status_pegawai', $pegawai->status_pegawai) ==
                                            'aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="nonaktif" {{ old('status_pegawai', $pegawai->status_pegawai) ==
                                            'nonaktif' ? 'selected' : '' }}>
                                            Nonaktif
                                        </option>
                                    </select>
