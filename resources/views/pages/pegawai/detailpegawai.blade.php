                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">{{ $pegawai->sisa_cuti_tahunan }} hari <a href="{{ route('pegawai.cuti.history')}}" class="badge bg-warning text-dark {{$pegawai->str->count() > 0 ? '' : 'd-none'}}">Lihat</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <tbody>
                                @if ($pegawai->status_tipe == 'pns')
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col">{{ $pegawai->sip->sortByDesc('tanggal_terbit_sip')->first()->masa_berakhir_sip ?? '-' }} <a href="{{route('pegawai.sip.history',['pegawai' => $pegawai->id])}}" class="badge bg-warning text-dark {{$pegawai->sip->count() > 0 ? '' : 'd-none'}}">Lihat</a></td>
                                    </tr>
                                    @endif
                                   ...
                                   @if ($pegawai->jenis_tenaga == 'nakes')
                                    ...
                                    <tr>
                                        <th scope="col" class="judul-text">Tanggal Berakhir SIP</th>
                                        <td scope="col">{{ $pegawai->sip->sortByDesc('tanggal_terbit_sip')->first() ? 'tes' : '-' }} <a href="{{route('pegawai.sip.history' , ['pegawai' => $pegawai->id])}}" class="badge bg-warning text-dark {{$pegawai->sip->count() > 0 ? '' : 'd-none'}}">Lihat</a></td>
                                    </tr>
                                    @endif
                                    @else
                                    <tr>
