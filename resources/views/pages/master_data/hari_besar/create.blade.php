...
@section('content')
    ...
    <div class="card p-4 mx-lg-5 mb-5 ">
        <h3 class="m-0 font-weight-bold text-dark">Form Tambah Hari Besar</h3>
        <hr class="font-weight-bold">
        <form action="{{ route('admin.hariBesar.store') }}" method="post">
            @csrf
            <div class="row">
        ...
        <div class="text-right">
            <a href="{{ route('admin.hariBesar.index') }}" class="btn bg-warning text-white">Kembali</a>
