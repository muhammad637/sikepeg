        ...
        <div class="card-header ">
            <div class="d-md-flex justify-content-between d-sm-block">
                ...
                <div class="dropdown mt-2">
                    <button class="btn btn-primary" data-target="#export-all" data-toggle="modal">Eksport Excel</button>
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="export-all">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Eksport Cuti</h5>

                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="{{ route('admin.cuti.histori-cuti.export-all') }}" method="get">
                            @csrf
